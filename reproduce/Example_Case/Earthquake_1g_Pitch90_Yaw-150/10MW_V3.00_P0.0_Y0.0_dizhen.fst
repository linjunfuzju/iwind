...
0.01            WtrDpth       - Water depth (m)
0             MSL2SWL       - Offset between still-water level and mean sea level (m) [positive upward]
---------------------- INPUT FILES ---------------------------------------------
"NRELOffshrBsline10MW_OC3Monopile_ElastoDyn_V3.00_P0.0_Y0.0.dat" EDFile        - Name of file containing ElastoDyn input parameters (quoted string)
"unused"      BDBldFile(1)  - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"unused"      BDBldFile(2)  - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"unused"      BDBldFile(3)  - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"NRELOffshrBsline10MW_InflowWind_V3.00_1.dat" InflowFile    - Name of file containing inflow wind input parameters (quoted string)
"NRELOffshrBsline10MW_OC3Monopile_AeroDyn15_DGC.dat" AeroFile      - Name of file containing aerodynamic input parameters (quoted string)
"ServoDyn_PC5VS5_softcutout_hyperbolic.dat" ServoFile     - Name of file containing control and electrical-drive input parameters (quoted string)
"NRELOffshrBsline10MW_OC3Monopile_HydroDyn_H4.4900_T9.9400.dat" HydroFile     - Name of file containing hydrodynamic input parameters (quoted string)
"NRELOffshrBsline10MW_OC3Monopile_SubDyn_pymtheta_DGC_Water20_Pilelength80.dat" SubFile       - Name of file containing sub-structural input parameters (quoted string)
"unused"      MooringFile   - Name of file containing mooring system input parameters (quoted string)
"unused"      IceFile       - Name of file containing ice input parameters (quoted string)
"NRELOffshrBsline10MW_OC3Monopile_SoilDyn_pymtheta_CNECS_DGC_Water20_Pilelength80.dat" SoilFile      - Name of the file containing the SoilDyn input parameters (quoted string)
---------------------- OUTPUT --------------------------------------------------
